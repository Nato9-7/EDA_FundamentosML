...
const RegresionForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await predictionService.predecirRegresion(formData);
      ...
      <form onSubmit={handleSubmit} className="cs-form">
        ...
        <div className="form-buttons">
          <button 
            ...
            className="cs-button"
          >
            {loading ? 'Prediciendo...' : 'Predecir Kills'}
          </button>
        </div>
      </form>
        ...
        <div className="resultado-prediccion">
          ...
          {resultado.error ? (
            ...
            <div className="prediction-result">
              <p className="result kills-prediction">
                <strong>Kills Estimados:</strong> {resultado.kills_estimados.toFixed(1)}
              </p>
            </div>
          )}
        </div>
